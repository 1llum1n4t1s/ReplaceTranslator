...
## [1.0.28] — Git 記録日: 2026-09-25

- GPT-6 Luna・Sol・Astra をモデル一覧から選べるようにする
- 各社の新モデルが価格未登録や日付付き ID を理由に一覧から消えないようにし、未知モデルへの翻訳リクエストを改善する
- Grok 4.7、DeepSeek Flash、Groq Qwen 3.8 に対応し、廃止モデルからの切り替えを改善する

## [1.0.27] — Git 記録日: 2026-09-12

- 自動翻訳の除外リストへ、現在開いているサイトをホスト名だけで追加できるようにする
- ポップアップに同梱する日本語フォントを更新する

## [1.0.26] — Git 記録日: 2026-09-06

- Elgato Marketplace の概要・新着情報など、読み取り専用の本文が自動翻訳から除外される問題を修正する
