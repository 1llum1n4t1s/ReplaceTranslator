...
const COPY = {
  ...
  '02-popup-translate': {
    ja: {
      ...
      tabTranslate: '翻訳', tabApi: 'API設定', autoLabel: '全ページ自動翻訳',
    ...
    en: {
      ...
      tabTranslate: 'Translate', tabApi: 'Keys', autoLabel: 'Auto-translate every page',
  ...
  '03-popup-api': {
    ja: {
      ...
      tabTranslate: '翻訳', tabApi: 'API設定', tagPay: '従量課金', tagFree: '無料枠あり', tagNokey: 'キー不要',
    },
    en: {
      ...
      tabTranslate: 'Translate', tabApi: 'Keys', tagPay: 'Pay as you go', tagFree: 'Free tier', tagNokey: 'No key',
    },
  },
  '04-floating-button': {
