...
(function () {
  ...
  async function ensureContentFlags() {
    ...
    if (cur && typeof cur.imageCapable === "boolean" && typeof cur.selectionTranslate === "boolean" && typeof cur.selectionMode === "string") return; // 新フィールドまで揃っていれば何もしない
    // 未作成 / 旧フォーマット (imageCapable / selectionTranslate / selectionMode 欠落 = 更新前のインストール) は SETTINGS から導出して補完する。
